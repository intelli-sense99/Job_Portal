    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item ">
                    <a class="nav-link " href="{{ route('subject.jobs') }}">Jobs</a>
                </li>
                @if ($role == 1 && count($is_skills) > 0)
                    <li class="nav-item ">
                        <a class="nav-link " href="{{ route('featured.jobs') }}">Featured Jobs</a>
                    </li>
                @endif
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <button class="btn btn-dark  " type="submit">
                            ...
                            <a href="{{ url('/home') }}" class=" text-decoration-none text-white py-1 px-3">Home</a>
                        </button>
                    @else
                        <button class="btn btn-dark"type="submit">
