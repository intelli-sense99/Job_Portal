                                    ...
                                    <section>
                                        <div class="p-4">
                                            ...
                                            <div class=" pb-1 d-flex justify-content-between ">
                                                ...
                                                <span class="text-secondary mx-3" style="font-size: 13px;">
                                                    @php
                                                        $range = getRange($val->getInquiries->count());
                                                    @endphp
                                                    Proposals : {{ $range ?? '0' }}
                                            ...
                                            <div>
                                                ...
                                                <span class="text-secondary" style="font-size: 13px;"> <i
                                                    ...
                                                    <?php echo $val->getEmployer ? $val->getEmployer->getState->state : null; ?>
                                                </span>
                                            </div>
                                            <div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="text-secondary" style="font-size: 12px;"><i
                                                        class="fa-regular fa-calendar px-1"></i><?php echo date('d/M/Y', strtotime($val->created_at)); ?></span>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="job-form">
                            <div class="modal-body">
                                ...
                                <input type="hidden" class="form-control modal_job_id" name="job_id" value="">
