                ...
                <div class="row">
                    ...
                    <div class="col-md-3 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img
                                ...
                                src="{{ asset('storage') . '/uploads/' . $data->image }}" style=" object-fit: cover;"><span
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Company Name" name="company"
                                        value="{{ isset($data->profile->company_name) ? $data->profile->company_name : '' }}">
                                    @error('company')
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Company address" name="address"
                                        value="{{ isset($data->profile->location) ? $data->profile->location : '' }}">
                                    @error('address')
                                        <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Longitude" name="longitude"
                                        value="{{ isset($data->profile->lat) ? $data->profile->lat : '' }}">
                                    @error('longitude')
                                        <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Latitude" name="latitude"
                                        value="{{ isset($data->profile->long) ? $data->profile->long : '' }}">
                                    @error('latitude')
                                        <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="p-3 mt-4">
                            ...
                            <div class="col-md-12"><label class="labels-input">Compony Contact Number </label>
                                <input type="text" class="form-control" placeholder="Company phone number" name="phone"
                                    value="{{ isset($data->profile->company_phone) ? $data->profile->company_phone : '' }}">
                                @error('phone')
                                    <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="text" class="form-control" placeholder="Your Experience" name="experience"
                                    value="{{ isset($data->profile->experience) ? $data->profile->experience : '' }}">
                                @error('experience')
                                    <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                <label class="labels-input">Position</label>
                                <input type="text" class="form-control" placeholder="Position in company"
                                    name="position"
                                    value="{{ isset($data->profile->position) ? $data->profile->position : '' }}">
                                @error('position')
                                    <div class="text-danger pt-2 px-3">{{ $message }}</div>
                                @enderror
                            </div>
