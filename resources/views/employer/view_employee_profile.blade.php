                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ asset('storage') . '/uploads/' . $data->image }}" alt="Admin"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <span>
                                                    <i class="fa-regular fa-eye fa-fw fa-lg"></i>

                                                    <a class="lower text-decoration-none  py-0 "
                                                        href="{{ asset('storage') . '/cv/' . $data->getEmployeeData->resume }}">
                                                        View Resume
                                                    </a>
                                                </span>
                                            </div>
                        ...
                        <div class="card mt-3">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{ $data->getEmployeeData->portfolio ?? 'N/A' }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <span class="text-secondary">{{ $data->getEmployeeData->github ?? 'N/A' }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <span class="text-secondary">{{ $data->getEmployeeData->twitter ?? 'N/A' }}</span>
                                </li>
                                {{-- <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary text-capitalize">
                                        {{ $data->getEmployeeData->gender ?? 'N/A' }}
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{ $data->getEmployeeData->company_name ?? 'N/A' }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{ $data->getEmployeeData->position ?? 'N/A' }}
